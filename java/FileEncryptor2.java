...
public class FileEncryptor
{
	...
	InvalidKeyException, IllegalBlockSizeException, BadPaddingException
	{
		...
		Cipher engine = Cipher.getInstance("DES/CBC/PKCS5Padding");		// Get the instace of the Cipher Engine

		engine.init(Cipher.ENCRYPT_MODE, secretKey);			        // Initiatlize the Cipher Engine with Encrypt Mode
